...
public class MainActivity extends AppCompatActivity {
    private static final String API_KEY = "3148a676f0e15f3c3ff2cf56956f15ca";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnObtenerPeliculasPopulares = findViewById(R.id.Populares);
        Button btnBuscarPeliculas = findViewById(R.id.Peliculas);
        Button btnDetallesPelicula = findViewById(R.id.Detalles);
